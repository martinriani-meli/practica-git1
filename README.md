...
- [3. Interactuar con el servicio ](#3-Interactuar-con-el-servicio)
    - [3.1. US01. Ingresar lote en warehouse de fulfillment](#31-US01-Ingresar-lote-en-warehouse-de-fulfillment)
    - [3.2. US02. Registrar Venta: Agregar producto al carrito de compras](#32-US02-Registrar-Venta---Agregar-producto-al-carrito-de-compras)
    - [3.3. US03. Consultar ubicación de un producto en el warehouse](#33-US03-Consultar-ubicación-de-un-producto-en-el-warehouse)
